...
void AmpshooterCharacter::OpenLobby() {
...
void AmpshooterCharacter::CallOpenLevel(const FString& Address)
{
	UGameplayStatics::OpenLevel(this, *Address);
}

void AmpshooterCharacter::CallClientTravel(const FString& Address)
{
...
void AmpshooterCharacter::CreateGameSession()
{
...
void AmpshooterCharacter::OnCreateSessionComplete(FName SessionName, bool bWasSuccessful)
{
	if(bWasSuccessful)
	{
		if (GEngine)
...
void AmpshooterCharacter::OnFindSessionComplete(bool bWasSuccessful)
{
	...
	if(!OnlineSessionInterface.IsValid())
	{
		...
		if (GEngine)
		{
			GEngine->AddOnScreenDebugMessage(-1, 15.f, FColor::Red, FString(TEXT("Online session interface is invalid!")));
		}
	}
...
void AmpshooterCharacter::OnJoinSessionComplete(FName SessionName, EOnJoinSessionCompleteResult::Type Result)
{
	if(!OnlineSessionInterface.IsValid())
	{
		return;
